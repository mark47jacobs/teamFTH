...
export class LandingPageComponent implements OnInit {
  ...
  {
    "src": "../../assets/hattieMcDaniel.jpeg",
  ...
  {
    "src": "../../assets/malalaYousafzai.jpeg",
  ...
  {
    "src": "../../assets/serenaWilliams.jpeg",
  ...
  addFunnyAnimation(index) {
    ...
    container.addEventListener("mouseenter", (e: MouseEvent) => {
      ...
      if (index != 3) {
        ...
        description.style.transform = "translateZ(55px)";
